...
public class IrregularChefItems {
	...
	public static final RegistryObject<Item> STEAMED_BEEF_WRAP = HELPER.createItem("steamed_beef_wrap", () -> new SingleEffect(
			new Item.Properties().food(Foods.STEAMED_BEEF_WRAP).group(ItemGroup.FOOD),
	...
	static class Foods {
		...
		public static final Food HUNTERS_CASSEROLE = (new Food.Builder()).hunger(11).saturation(0.7F).effect(() -> new EffectInstance(Effects.INVISIBILITY, 300, 0, true, false), 1.0F).effect(() -> new EffectInstance(Effects.STRENGTH, 200, 1, false, true), 1.0F).build();
